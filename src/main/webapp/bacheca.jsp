...
<script>
    window.onload = function (){ /*questa funzione serve a chiamare la funzione per caricare le storie*/
    ...
    let listaReazioni;
    let storia;
    function caricaStorie(){ /*questa funzione carica le storie*/
        ...
        xhttp.onreadystatechange = function() {
            ...
            else if((this.readyState == 4)){ /*se lo stato non è 200 ma è pronto, vuol dire che c'è stato un errore*/
    ...
    function validateData(){ /*questa funzione serve a validare i dati della storia*/
    ...
    function listatore(storiaReazione){ /*questa funzione visualizza l'icona della reazione riempita nel caso in cui la reazione sia stata inserita*/
    ...
    function pubblicaStoria(){ /*questa funzione serve a pubblicare le storie*/
        let xhttp = new XMLHttpRequest();
    ...
    function aggiornamento() /*questa funzione effettua un aggiornamento*/
    {
        window.location.reload();
    };

    function aggiungiReazione(storia) /*questa funzione aggiounge una reazione solo se l'utente non l'ha già inserita*/
    {
        var pulsante =document.getElementById(storia+"i"); /*prende l'id della storia*/

        if(pulsante.classList.contains("false")) /*se il pulsante non è stato premuto*/
        {
            console.log("accepting reaction")
            impostaReazione(storia); /*la reazione viene inserita*/
        }
    }

    function impostaReazione(storia) /*funzione che imposta la reazione*/
    {
        let xhttp = new XMLHttpRequest();
        let contatore;
        xhttp.onreadystatechange = function () {
