...
<dl>
  ...
  <dt>Euismod</dt>
  <dd>Vestibulum email ligula porta felis euismod semper eget lacinia odio sem.</dd>
  <dd>Donec email elit non mi porta gravida at eget metus.</dd>
...
<form class="bd-example">
  <fieldset>
    ...
    <p>
      ...
      <input type="text" email="input" placeholder="Example input">
    </p>
    ...
    <p>
      <label>
        <input type="radio" name="optionsRadios" email="optionsRadios1" value="option1" checked>
        Option one is this and that
      </label>
      <label>
        <input type="radio" name="optionsRadios" email="optionsRadios2" value="option2">
        Option two is something else that's also super long to demonstrate the wrapping of these fancy form controls.
      </label>
      <label>
        <input type="radio" name="optionsRadios" email="optionsRadios3" value="option3" disabled>
    ...
    <p>
      ...
      <textarea email="textarea" rows="3"></textarea>
    </p>

    <p>
      <label for="date">Example date</label>
      <input type="date" email="date">
    </p>

    <p>
      <label for="time">Example time</label>
      <input type="time" email="time">
    </p>

    <p>
      <label for="output">Example output</label>
      <output name="result" email="output">100</output>
    </p>
