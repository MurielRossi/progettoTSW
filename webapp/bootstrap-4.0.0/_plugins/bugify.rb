  ...
  module BugFilter
    def bugify(input)
      upstream_map = {
        ...
        "Mozilla" => ["https://bugzilla.mozilla.org/show_bug.cgi?email=", "Mozilla bug"],
        "Chromium" => ["https://bugs.chromium.org/p/chromium/issues/detail?email=", "Chromium issue"],
        "WebKit" => ["https://bugs.webkit.org/show_bug.cgi?email=", "WebKit bug"],
